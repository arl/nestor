...
var defs = [256]opdef{
	{i: 0x00, n: "BRK", d: no, m: "imp"},
	{i: 0x01, n: "ORA", d: rd, m: "izx", f: ORA},
	{i: 0x02, n: "STP", d: no, m: "imp", f: STP(0x02)},
	{i: 0x03, n: "SLO", d: rw, m: "izx", f: SLO},
	{i: 0x04, n: "NOP", d: no, m: "zpg", f: NOP(true)},
	{i: 0x05, n: "ORA", d: rd, m: "zpg", f: ORA},
	{i: 0x06, n: "ASL", d: rw, m: "zpg", f: ASL_mem},
	{i: 0x07, n: "SLO", d: rw, m: "zpg", f: SLO},
	{i: 0x08, n: "PHP", d: no, m: "imp", f: PHP},
	{i: 0x09, n: "ORA", d: rd, m: "imm", f: ORA},
	{i: 0x0A, n: "ASL", d: no, m: "acc", f: ASL},
	{i: 0x0B, n: "ANC", d: rd, m: "imm", f: ANC},
	{i: 0x0C, n: "NOP", d: no, m: "abs", f: NOP(true)},
	{i: 0x0D, n: "ORA", d: rd, m: "abs", f: ORA},
	{i: 0x0E, n: "ASL", d: rw, m: "abs", f: ASL_mem},
	{i: 0x0F, n: "SLO", d: rw, m: "abs", f: SLO},
	{i: 0x10, n: "BPL", d: no, m: "rel", f: branch(Negative, false)},
	{i: 0x11, n: "ORA", d: rd, m: "izy", f: ORA},
	{i: 0x12, n: "STP", d: no, m: "imp", f: STP(0x12)},
	{i: 0x13, n: "SLO", d: rw, m: "izyd", f: SLO},
	{i: 0x14, n: "NOP", d: no, m: "zpx", f: NOP(true)},
	{i: 0x15, n: "ORA", d: rd, m: "zpx", f: ORA},
	{i: 0x16, n: "ASL", d: rw, m: "zpx", f: ASL_mem},
	{i: 0x17, n: "SLO", d: rw, m: "zpx", f: SLO},
	{i: 0x18, n: "CLC", d: no, m: "imp", f: clear(Carry)},
	{i: 0x19, n: "ORA", d: rd, m: "aby", f: ORA},
	{i: 0x1A, n: "NOP", d: no, m: "imp", f: NOP(false)},
	{i: 0x1B, n: "SLO", d: rw, m: "abyd", f: SLO},
	{i: 0x1C, n: "NOP", d: no, m: "abx", f: NOP(true)},
	{i: 0x1D, n: "ORA", d: rd, m: "abx", f: ORA},
	{i: 0x1E, n: "ASL", d: rw, m: "abxd", f: ASL_mem},
	{i: 0x1F, n: "SLO", d: rw, m: "abxd", f: SLO},
	{i: 0x20, n: "JSR", d: no, m: "abs"},
	{i: 0x21, n: "AND", d: rd, m: "izx", f: AND},
	{i: 0x22, n: "STP", d: no, m: "imp", f: STP(0x22)},
	{i: 0x23, n: "RLA", d: rw, m: "izx", f: RLA},
	{i: 0x24, n: "BIT", d: rd, m: "zpg", f: BIT},
	{i: 0x25, n: "AND", d: rd, m: "zpg", f: AND},
	{i: 0x26, n: "ROL", d: rw, m: "zpg", f: ROL_mem},
	{i: 0x27, n: "RLA", d: rw, m: "zpg", f: RLA},
	{i: 0x28, n: "PLP", d: no, m: "imp", f: PLP},
	{i: 0x29, n: "AND", d: rd, m: "imm", f: AND},
	{i: 0x2A, n: "ROL", d: no, m: "acc", f: ROL},
	{i: 0x2B, n: "ANC", d: rd, m: "imm", f: ANC},
	{i: 0x2C, n: "BIT", d: rd, m: "abs", f: BIT},
	{i: 0x2D, n: "AND", d: rd, m: "abs", f: AND},
	{i: 0x2E, n: "ROL", d: rw, m: "abs", f: ROL_mem},
	{i: 0x2F, n: "RLA", d: rw, m: "abs", f: RLA},
	{i: 0x30, n: "BMI", d: no, m: "rel", f: branch(Negative, true)},
	{i: 0x31, n: "AND", d: rd, m: "izy", f: AND},
	{i: 0x32, n: "STP", d: no, m: "imp", f: STP(0x32)},
	{i: 0x33, n: "RLA", d: rw, m: "izyd", f: RLA},
	{i: 0x34, n: "NOP", d: no, m: "zpx", f: NOP(true)},
	{i: 0x35, n: "AND", d: rd, m: "zpx", f: AND},
	{i: 0x36, n: "ROL", d: rw, m: "zpx", f: ROL_mem},
	{i: 0x37, n: "RLA", d: rw, m: "zpx", f: RLA},
	{i: 0x38, n: "SEC", d: no, m: "imp", f: set(Carry)},
	{i: 0x39, n: "AND", d: rd, m: "aby", f: AND},
	{i: 0x3A, n: "NOP", d: no, m: "imp", f: NOP(false)},
	{i: 0x3B, n: "RLA", d: rw, m: "abyd", f: RLA},
	{i: 0x3C, n: "NOP", d: no, m: "abx", f: NOP(true)},
	{i: 0x3D, n: "AND", d: rd, m: "abx", f: AND},
	{i: 0x3E, n: "ROL", d: rw, m: "abxd", f: ROL_mem},
	{i: 0x3F, n: "RLA", d: rw, m: "abxd", f: RLA},
	{i: 0x40, n: "RTI", d: no, m: "imp", f: RTI},
	{i: 0x41, n: "EOR", d: rd, m: "izx", f: EOR},
	{i: 0x42, n: "STP", d: no, m: "imp", f: STP(0x42)},
	{i: 0x43, n: "SRE", d: rw, m: "izx", f: SRE},
	{i: 0x44, n: "NOP", d: no, m: "zpg", f: NOP(true)},
	{i: 0x45, n: "EOR", d: rd, m: "zpg", f: EOR},
	{i: 0x46, n: "LSR", d: rw, m: "zpg", f: LSR_mem},
	{i: 0x47, n: "SRE", d: rw, m: "zpg", f: SRE},
	{i: 0x48, n: "PHA", d: no, m: "imp", f: PHA},
	{i: 0x49, n: "EOR", d: rd, m: "imm", f: EOR},
	{i: 0x4A, n: "LSR", d: no, m: "acc", f: LSR},
	{i: 0x4B, n: "ALR", d: rd, m: "imm", f: ALR},
	{i: 0x4C, n: "JMP", d: no, m: "abs", f: JMP},
	{i: 0x4D, n: "EOR", d: rd, m: "abs", f: EOR},
	{i: 0x4E, n: "LSR", d: rw, m: "abs", f: LSR_mem},
	{i: 0x4F, n: "SRE", d: rw, m: "abs", f: SRE},
	{i: 0x50, n: "BVC", d: no, m: "rel", f: branch(Overflow, false)},
	{i: 0x51, n: "EOR", d: rd, m: "izy", f: EOR},
	{i: 0x52, n: "STP", d: no, m: "imp", f: STP(0x52)},
	{i: 0x53, n: "SRE", d: rw, m: "izyd", f: SRE},
	{i: 0x54, n: "NOP", d: no, m: "zpx", f: NOP(true)},
	{i: 0x55, n: "EOR", d: rd, m: "zpx", f: EOR},
	{i: 0x56, n: "LSR", d: rw, m: "zpx", f: LSR_mem},
	{i: 0x57, n: "SRE", d: rw, m: "zpx", f: SRE},
	{i: 0x58, n: "CLI", d: no, m: "imp", f: clear(Interrupt)},
	{i: 0x59, n: "EOR", d: rd, m: "aby", f: EOR},
	{i: 0x5A, n: "NOP", d: no, m: "imp", f: NOP(false)},
	{i: 0x5B, n: "SRE", d: rw, m: "abyd", f: SRE},
	{i: 0x5C, n: "NOP", d: no, m: "abx", f: NOP(true)},
	{i: 0x5D, n: "EOR", d: rd, m: "abx", f: EOR},
	{i: 0x5E, n: "LSR", d: rw, m: "abxd", f: LSR_mem},
	{i: 0x5F, n: "SRE", d: rw, m: "abxd", f: SRE},
	{i: 0x60, n: "RTS", d: no, m: "imp", f: RTS},
	{i: 0x61, n: "ADC", d: rd, m: "izx", f: ADC},
	{i: 0x62, n: "STP", d: no, m: "imp", f: STP(0x62)},
	{i: 0x63, n: "RRA", d: rw, m: "izx", f: RRA},
	{i: 0x64, n: "NOP", d: no, m: "zpg", f: NOP(true)},
	{i: 0x65, n: "ADC", d: rd, m: "zpg", f: ADC},
	{i: 0x66, n: "ROR", d: rw, m: "zpg", f: ROR_mem},
	{i: 0x67, n: "RRA", d: rw, m: "zpg", f: RRA},
	{i: 0x68, n: "PLA", d: no, m: "imp", f: PLA},
	{i: 0x69, n: "ADC", d: rd, m: "imm", f: ADC},
	{i: 0x6A, n: "ROR", d: no, m: "acc", f: ROR},
	{i: 0x6B, n: "ARR", d: rd, m: "imm", f: ARR},
	{i: 0x6C, n: "JMP", d: no, m: "ind", f: JMP},
	{i: 0x6D, n: "ADC", d: rd, m: "abs", f: ADC},
	{i: 0x6E, n: "ROR", d: rw, m: "abs", f: ROR_mem},
	{i: 0x6F, n: "RRA", d: rw, m: "abs", f: RRA},
	{i: 0x70, n: "BVS", d: no, m: "rel", f: branch(Overflow, true)},
	{i: 0x71, n: "ADC", d: rd, m: "izy", f: ADC},
	{i: 0x72, n: "STP", d: no, m: "imp", f: STP(0x72)},
	{i: 0x73, n: "RRA", d: rw, m: "izyd", f: RRA},
	{i: 0x74, n: "NOP", d: no, m: "zpx", f: NOP(true)},
	{i: 0x75, n: "ADC", d: rd, m: "zpx", f: ADC},
	{i: 0x76, n: "ROR", d: rw, m: "zpx", f: ROR_mem},
	{i: 0x77, n: "RRA", d: rw, m: "zpx", f: RRA},
	{i: 0x78, n: "SEI", d: no, m: "imp", f: set(Interrupt)},
	{i: 0x79, n: "ADC", d: rd, m: "aby", f: ADC},
	{i: 0x7A, n: "NOP", d: no, m: "imp", f: NOP(false)},
	{i: 0x7B, n: "RRA", d: rw, m: "abyd", f: RRA},
	{i: 0x7C, n: "NOP", d: no, m: "abx", f: NOP(true)},
	{i: 0x7D, n: "ADC", d: rd, m: "abx", f: ADC},
	{i: 0x7E, n: "ROR", d: rw, m: "abxd", f: ROR_mem},
	{i: 0x7F, n: "RRA", d: rw, m: "abxd", f: RRA},
	{i: 0x80, n: "NOP", d: rd, m: "imm", f: NOP(false)},
	{i: 0x81, n: "STA", d: no, m: "izx", f: ST("A")},
	{i: 0x82, n: "NOP", d: rd, m: "imm", f: NOP(false)},
	{i: 0x83, n: "SAX", d: no, m: "izx", f: SAX},
	{i: 0x84, n: "STY", d: no, m: "zpg", f: ST("Y")},
	{i: 0x85, n: "STA", d: no, m: "zpg", f: ST("A")},
	{i: 0x86, n: "STX", d: no, m: "zpg", f: ST("X")},
	{i: 0x87, n: "SAX", d: no, m: "zpg", f: SAX},
	{i: 0x88, n: "DEY", d: no, m: "imp", f: dey},
	{i: 0x89, n: "NOP", d: rd, m: "imm", f: NOP(false)},
	{i: 0x8A, n: "TXA", d: no, m: "imp", f: T("X", "A")},
	{i: 0x8B, n: "ANE", d: rd, m: "imm", f: unstable(0x8B)},
	{i: 0x8C, n: "STY", d: no, m: "abs", f: ST("Y")},
	{i: 0x8D, n: "STA", d: no, m: "abs", f: ST("A")},
	{i: 0x8E, n: "STX", d: no, m: "abs", f: ST("X")},
	{i: 0x8F, n: "SAX", d: no, m: "abs", f: SAX},
	{i: 0x90, n: "BCC", d: no, m: "rel", f: branch(Carry, false)},
	{i: 0x91, n: "STA", d: no, m: "izyd", f: ST("A")},
	{i: 0x92, n: "STP", d: no, m: "imp", f: STP(0x92)},
	{i: 0x93, n: "SHA", d: rd, m: "izy", f: unstable(0x93)},
	{i: 0x94, n: "STY", d: no, m: "zpx", f: ST("Y")},
	{i: 0x95, n: "STA", d: no, m: "zpx", f: ST("A")},
	{i: 0x96, n: "STX", d: no, m: "zpy", f: ST("X")},
	{i: 0x97, n: "SAX", d: no, m: "zpy", f: SAX},
	{i: 0x98, n: "TYA", d: no, m: "imp", f: T("Y", "A")},
	{i: 0x99, n: "STA", d: no, m: "abyd", f: ST("A")},
	{i: 0x9A, n: "TXS", d: no, m: "imp", f: T("X", "SP")},
	{i: 0x9B, n: "TAS", d: rd, m: "abx", f: unstable(0x9B)},
	{i: 0x9C, n: "SHY", d: rd, m: "aby", f: unstable(0x9C)},
	{i: 0x9D, n: "STA", d: no, m: "abxd", f: ST("A")},
	{i: 0x9E, n: "SHX", d: rd, m: "abx", f: unstable(0x9E)},
	{i: 0x9F, n: "SHA", d: rd, m: "aby", f: unstable(0x9F)},
	{i: 0xA0, n: "LDY", d: rd, m: "imm", f: LD("Y")},
	{i: 0xA1, n: "LDA", d: rd, m: "izx", f: LD("A")},
	{i: 0xA2, n: "LDX", d: rd, m: "imm", f: LD("X")},
	{i: 0xA3, n: "LAX", d: rd, m: "izx", f: LD("A", "X")},
	{i: 0xA4, n: "LDY", d: rd, m: "zpg", f: LD("Y")},
	{i: 0xA5, n: "LDA", d: rd, m: "zpg", f: LD("A")},
	{i: 0xA6, n: "LDX", d: rd, m: "zpg", f: LD("X")},
	{i: 0xA7, n: "LAX", d: rd, m: "zpg", f: LD("A", "X")},
	{i: 0xA8, n: "TAY", d: no, m: "imp", f: T("A", "Y")},
	{i: 0xA9, n: "LDA", d: rd, m: "imm", f: LD("A")},
	{i: 0xAA, n: "TAX", d: no, m: "imp", f: T("A", "X")},
	{i: 0xAB, n: "LXA", d: rd, m: "imm", f: LXA},
	{i: 0xAC, n: "LDY", d: rd, m: "abs", f: LD("Y")},
	{i: 0xAD, n: "LDA", d: rd, m: "abs", f: LD("A")},
	{i: 0xAE, n: "LDX", d: rd, m: "abs", f: LD("X")},
	{i: 0xAF, n: "LAX", d: rd, m: "abs", f: LD("A", "X")},
	{i: 0xB0, n: "BCS", d: no, m: "rel", f: branch(Carry, true)},
	{i: 0xB1, n: "LDA", d: rd, m: "izy", f: LD("A")},
	{i: 0xB2, n: "STP", d: no, m: "imp", f: STP(0xB2)},
	{i: 0xB3, n: "LAX", d: rd, m: "izy", f: LD("A", "X")},
	{i: 0xB4, n: "LDY", d: rd, m: "zpx", f: LD("Y")},
	{i: 0xB5, n: "LDA", d: rd, m: "zpx", f: LD("A")},
	{i: 0xB6, n: "LDX", d: rd, m: "zpy", f: LD("X")},
	{i: 0xB7, n: "LAX", d: rd, m: "zpy", f: LD("A", "X")},
	{i: 0xB8, n: "CLV", d: no, m: "imp", f: clear(Overflow)},
	{i: 0xB9, n: "LDA", d: rd, m: "aby", f: LD("A")},
	{i: 0xBA, n: "TSX", d: no, m: "imp", f: T("SP", "X")},
	{i: 0xBB, n: "LAS", d: rd, m: "aby", f: LAS},
	{i: 0xBC, n: "LDY", d: rd, m: "abx", f: LD("Y")},
	{i: 0xBD, n: "LDA", d: rd, m: "abx", f: LD("A")},
	{i: 0xBE, n: "LDX", d: rd, m: "aby", f: LD("X")},
	{i: 0xBF, n: "LAX", d: rd, m: "aby", f: LD("A", "X")},
	{i: 0xC0, n: "CPY", d: rd, m: "imm", f: cmp("Y")},
	{i: 0xC1, n: "CMP", d: rd, m: "izx", f: cmp("A")},
	{i: 0xC2, n: "NOP", d: rd, m: "imm", f: NOP(false)},
	...
	{i: 0xD2, n: "STP", d: no, m: "imp", f: STP(0xD2)},
	{i: 0xD3, n: "DCP", d: rd, m: "izyd", f: DCP},
	{i: 0xD4, n: "NOP", d: no, m: "zpx", f: NOP(true)},
	...
	{i: 0xDA, n: "NOP", d: no, m: "imp", f: NOP(false)},
	{i: 0xDB, n: "DCP", d: rd, m: "abyd", f: DCP},
	{i: 0xDC, n: "NOP", d: no, m: "abx", f: NOP(true)},
	...
	{i: 0xE2, n: "NOP", d: rd, m: "imm", f: NOP(false)},
	{i: 0xE3, n: "ISC", d: rd, m: "izx", f: ISC},
	{i: 0xE4, n: "CPX", d: rd, m: "zpg", f: cmp("X")},
	{i: 0xE5, n: "SBC", d: rd, m: "zpg", f: SBC},
	{i: 0xE6, n: "INC", d: rd, m: "zpg", f: INC},
	{i: 0xE7, n: "ISC", d: rd, m: "zpg", f: ISC},
	{i: 0xE8, n: "INX", d: no, m: "imp", f: inx},
	{i: 0xE9, n: "SBC", d: rd, m: "imm", f: SBC},
	{i: 0xEA, n: "NOP", d: no, m: "imp", f: NOP(false)},
	{i: 0xEB, n: "SBC", d: rd, m: "imm", f: SBC},
	{i: 0xEC, n: "CPX", d: rd, m: "abs", f: cmp("X")},
	{i: 0xED, n: "SBC", d: rd, m: "abs", f: SBC},
	{i: 0xEE, n: "INC", d: rd, m: "abs", f: INC},
	{i: 0xEF, n: "ISC", d: rd, m: "abs", f: ISC},
	{i: 0xF0, n: "BEQ", d: no, m: "rel", f: branch(Zero, true)},
	{i: 0xF1, n: "SBC", d: rd, m: "izy", f: SBC},
	{i: 0xF2, n: "STP", d: no, m: "imp", f: STP(0xF2)},
	{i: 0xF3, n: "ISC", d: rd, m: "izyd", f: ISC},
	{i: 0xF4, n: "NOP", d: no, m: "zpx", f: NOP(true)},
	{i: 0xF5, n: "SBC", d: rd, m: "zpx", f: SBC},
	{i: 0xF6, n: "INC", d: rd, m: "zpx", f: INC},
	{i: 0xF7, n: "ISC", d: rd, m: "zpx", f: ISC},
	{i: 0xF8, n: "SED", d: no, m: "imp", f: set(Decimal)},
	{i: 0xF9, n: "SBC", d: rd, m: "aby", f: SBC},
	{i: 0xFA, n: "NOP", d: no, m: "imp", f: NOP(false)},
	{i: 0xFB, n: "ISC", d: rd, m: "abyd", f: ISC},
	{i: 0xFC, n: "NOP", d: no, m: "abx", f: NOP(true)},
	{i: 0xFD, n: "SBC", d: rd, m: "abx", f: SBC},
	{i: 0xFE, n: "INC", d: rd, m: "abxd", f: INC},
	{i: 0xFF, n: "ISC", d: rd, m: "abxd", f: ISC},
}
