...
func opcode03(cpu *CPU) {
	...
	carry := val & 0x80
	val = (val << 1) & 0xfe
	cpu.P.clearFlags(Zero | Negative | Carry)
	cpu.P.setNZ(val)
	if carry != 0 {
...
func opcode8B(cpu *CPU) {
	val := cpu.fetch8()
	log.ModCPU.ErrorZ("unsupported unstable opcode").Hex8("code", 139).End()
	_ = val
	cpu.halt()
	_ = val
}
...
func opcode93(cpu *CPU) {
	oper := cpu.izy(false)
	val := cpu.Read8(oper)
	log.ModCPU.ErrorZ("unsupported unstable opcode").Hex8("code", 147).End()
	_ = val
	cpu.halt()
}
...
func opcode9B(cpu *CPU) {
	oper := cpu.abx(false)
	val := cpu.Read8(oper)
	log.ModCPU.ErrorZ("unsupported unstable opcode").Hex8("code", 155).End()
	_ = val
	cpu.halt()
}
...
func opcode9C(cpu *CPU) {
	oper := cpu.aby(false)
	val := cpu.Read8(oper)
	log.ModCPU.ErrorZ("unsupported unstable opcode").Hex8("code", 156).End()
	_ = val
	cpu.halt()
}
...
func opcode9E(cpu *CPU) {
	oper := cpu.abx(false)
	val := cpu.Read8(oper)
	log.ModCPU.ErrorZ("unsupported unstable opcode").Hex8("code", 158).End()
	_ = val
	cpu.halt()
}
...
func opcode9F(cpu *CPU) {
	oper := cpu.aby(false)
	val := cpu.Read8(oper)
	log.ModCPU.ErrorZ("unsupported unstable opcode").Hex8("code", 159).End()
	_ = val
	cpu.halt()
}
